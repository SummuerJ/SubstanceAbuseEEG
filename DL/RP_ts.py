...
for i in range(7):  # 7只小鼠
    ...
    for j in range(0, 5):  # 降采样后的每一条都可以用作数据
        ...
        while k + 6000 <= 108000:  # 108000:    # 采取30s判断
            ...
            rp1 = RecurrencePlot()  # threshold='point', percentage=20
            rp2 = RecurrencePlot()  # threshold='point', percentage=20
            rp3 = RecurrencePlot()  # threshold='point', percentage=20
            X_rp1 = rp1.fit_transform(activity_list1)
            X_rp2 = rp2.fit_transform(activity_list1)
            X_rp3 = rp3.fit_transform(activity_list1)

            X_im1 = ((X_rp1[0] + 1) / 2) * 255
            X_im2 = ((X_rp2[0] + 1) / 2) * 255
            X_im3 = ((X_rp3[0] + 1) / 2) * 255
