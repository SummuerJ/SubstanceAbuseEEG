...
def load_dataset():
    images, labels = load_h5py_to_np('20210510_Dataset_GADF_50x50x3_21494.h5')  # shuffle过

    # dataset = h5py.File('datasets/train_signs.h5', "r")

    train_set_x_orig = images[:17195]  # your train set features  # 23220  # 3512
    train_set_y_orig = labels[:17195]  # your train set labels  # 23220
    ...
    test_set_x_orig = images[17195:]  # your test set features  # 23220
    test_set_y_orig = labels[17195:]  # your test set labels  # 23220
...
# 对模型做实体化和编译工作
model = ResNet50(input_shape=(50, 50, 3), classes=2)  # 原来打算64*64*3的图片,修改
...
X_train = (X_train_orig) / 255.   # 原来在区间[-1,1]
...
model.fit(X_train, Y_train, epochs=10, batch_size=256, validation_split=0.1,  shuffle=True)  #
...
# model.save('20210408_ts_GADF_2_512.h5')
